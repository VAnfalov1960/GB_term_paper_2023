        ...
        <ul class="nav-menu" :class="{ opennav: openmobilenav }">
          <li class="back-btn">
            <div class="mobile-back text-right">
              <span @click="openmobilenav=false" title="Закрыть окно">Назад</span>
          ...
          >
          <!-- Ниже НЕВЕРНАЯ строка -->
          <!-- <a href="#" class="nav-link" @click="setActive(menuItem.title)"> -->
            <a href="javascript:void(0)" class="nav-link" @click="setActive(menuItem.title)">
              {{menuItem.title}}
              <span
                class="sub-arrow"
